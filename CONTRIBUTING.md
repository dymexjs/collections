<!-- omit in toc -->
# Contributing to @dymexjs/collections
...
- **Explain why this enhancement would be useful** to most @dymexjs/collections users. You may also want to point out the other projects that solved it better and which could serve as inspiration.
...
[@dymexjs Code of Conduct]: <https://github.com/dymexjs/collections/blob/main/CODE_OF_CONDUCT.md>
